    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(req -> {
                    ...
                    req.requestMatchers(HttpMethod.POST, "/api/pagamentos/**").hasAnyRole("ADMIN", "USUARIO");
                    req.requestMatchers(HttpMethod.PUT, "/api/pagamentos/**").hasAnyRole("ADMIN", "USUARIO");
                    req.requestMatchers(HttpMethod.DELETE, "/api/pagamentos/**").hasAnyRole("ADMIN", "USUARIO");
